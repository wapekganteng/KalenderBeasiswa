                                                    ...
                                                    <form action="{{ route('kategori.update', $item->id) }}" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="id_tingkat_studi">
                                                                <option value="">Pilih Tingkat Studi</option>
                                                                @foreach ($tingkat_studi as $ts)
                                                                <option value="{{ $ts->id }}" @if ($ts->id == $item->id_tingkat_studi) selected @endif>{{ $ts->nama }}</option>
                                                                @endforeach
                                                            </select>
                                                            <label for="id_negara">Negara</label>
                                                            <select class="form-control" name="id_negara">
                                                                <option value="">Pilih Negara</option>
                                                                @foreach ($negara as $n)
                                                                <option value="{{ $n->id }}" @if ($n->id == $item->id_negara) selected @endif>{{ $n->nama }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
