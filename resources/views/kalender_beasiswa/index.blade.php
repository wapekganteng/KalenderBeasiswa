                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-primary"
                                    data-toggle="modal"data-target="#TambahKalenderBeasiswa">Tambah Kalender</button>
                                <!--Button To Page Soft Delete-->
                                <a href="{{ route('kbeasiswa_soft_delete') }}" type="button"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select class="form-control" name="id_negara[]"
                                                                id="option_negara" multiple required>
                                                                @foreach ($negara as $i)
                                                        ...
                                                        <div>
                                                            ...
                                                            <select class="form-control" name="id_tingkat_studi[]"
                                                                id="option_tingkat_studi" multiple required>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="status_tampil" class="form-control">
                                                                            ...
                                                                            <option
                                                                                value="1"{{ $item->status_tampil == '1' ? 'selected' : '' }}>
                                                                                Tampil</option>
                                                                            <option
                                                                                value="0"{{ $item->status_tampil == '0' ? 'selected' : '' }}>
                                                                                Tidak Tampil</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
